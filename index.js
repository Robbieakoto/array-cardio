...
const newInventors = inventors.filter(inventor => inventor.year >= 1500 && inventor.year < 1600)
console.log(newInventors)


// Array.prototype.map()
// 2. Give us an array of the inventors first and last names
const mapedInventors = inventors.map(inventor => `${inventor.first} ${inventor.last}`) 
...
// console.log(`number of years lived is ${totalYears}`);
...
//print the middle elemnet in the singly linked list